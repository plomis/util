...
function getClientSize() {
  ...
  var height = window.innerHeight || document.documentElement.clientHeight; // 可见区域高度
...
function getOffset(node) {
  ...
  var docElem = document.documentElement; // 返回文档对象的根元素的只读属性（如<html>元素）
...
for (var x$2 = 0; x$2 < vendors.length && !raf; ++x$2) {
  raf = window[vendors[x$2] + "RequestAnimationFrame"];
  caf = window[vendors[x$2] + "CancelAnimationFrame"] || window[vendors[x$2] + "CancelRequestAnimationFrame"];
}
...
var requestAnimationFrame$1 = raf;
var cancelAnimationFrame$1 = caf;
